...
if (isset($_POST['add_product'])) {
   ...
   // Your ALTER statement with a placeholder for the column name
   $alterSql = "ALTER TABLE stock ADD COLUMN $column_name INT DEFAULT 0";
   ...
   if ($select_products->rowCount() > 0) {
      $message[] = 'product already exist! Please update the product.';
   } else {
      ...
      <div class="box-container">
         ...
         ?>
               <div class="box">
                  ...
                  <div class="cat">
                     <p>stock in hand: <?= $fetch_products['quantity']; ?>
                     <p>
                  </div>
